...
export default function NewUsers({ title }: trpcDataType) {
  const dailyData = trpc.dashboard.user.newUsers.useQuery('daily');
  const weeklyData = trpc.dashboard.user.newUsers.useQuery('weekly');
  const monthlyData = trpc.dashboard.user.newUsers.useQuery('monthly');
